...
- **Files**: model-archival/scripts/run.sh.
...
- **Files**: .cursor/rules/model-archival-project.mdc, .cursor/rules/archiver-codebase.mdc, model-archival/src/archiver/preflight.py, model-archival/src/archiver/cli.py, model-archival/src/archiver/scheduler.py, model-archival/src/archiver/models.py.
...
- **Files**: model-archival/config/registry.yaml.
...
- **Files**: model-archival/config/registry.yaml, model-archival/config/registry-legacy.yaml.
...
- **Files**: model-archival/src/archiver/cli.py, model-archival/src/archiver/aria2_manager.py, model-archival/scripts/run.sh.
...
- **Files**: model-archival/config/registry.yaml, /mnt/models/d5/priority_overrides.json.
...
- **Files**: model-archival/src/archiver/cli.py, model-archival/src/archiver/scheduler.py, model-archival/scripts/run.sh, model-archival/scripts/archiver-download.sh, model-archival/README.md, model-archival/docs/OPERATIONS.md, model-archival/docs/ARCHITECTURE.md.
