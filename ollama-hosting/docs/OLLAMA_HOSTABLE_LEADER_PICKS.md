...
## Suggested pull batches (`ollama-hosting/scripts/`)

- Broad coding + Gemma + MoE (quantized): `./scripts/pull-ollama-stack.sh`
- 70B dense + abliterated 70B: `./scripts/pull-ollama-70b-stack.sh`
