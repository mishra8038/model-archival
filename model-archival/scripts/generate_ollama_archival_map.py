...
Run after inventory refresh (e.g. end of ollama-sync.sh).
"""
...
def main() -> None:
    ...
    lines = [
        ...
        "**Qwen Coder** only; see `scripts/ollama-supermicro-prune-plan.sh` and "
        "`docs/OLLAMA-CACHE-POLICY.md`. Other tags should exist on the archival VM below before "
