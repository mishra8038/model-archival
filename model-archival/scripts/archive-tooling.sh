...
# Mirror all tooling projects from model-archival/config/registry.yaml onto D5.
#
...
echo "[archive-tooling] Reading tooling entries from model-archival/config/registry.yaml..."
